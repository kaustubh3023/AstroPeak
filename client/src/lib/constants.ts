...
export const TESTIMONIALS = [
  {
    ...
    rating: 5,
    content: 'The Vedic astrology reading was incredibly accurate and insightful. It helped me understand my life\'s purpose and make important career decisions with confidence.',
    initials: 'RS'
  },
  {
    id: 2,
    ...
    rating: 5,
    content: 'The numerology analysis and name correction service transformed my business. Within months, I saw significant improvements in opportunities and financial growth.',
    initials: 'PG'
  },
  {
    id: 3,
    ...
    rating: 5,
    content: 'The tarot reading session provided remarkable clarity during a difficult phase. The guidance helped me navigate challenges and find inner peace.',
    initials: 'AK'
  }
];
